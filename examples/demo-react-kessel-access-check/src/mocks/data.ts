...
export const workspaces = [
  { id: 'ws-1', type: 'workspace', name: 'Engineering Team', owner: 'user-1', createdAt: '2025-01-01' },
  { id: 'ws-2', type: 'workspace', name: 'Marketing Hub', owner: 'user-2', createdAt: '2025-01-05' },
  { id: 'ws-3', type: 'workspace', name: 'Sales Dashboard', owner: 'user-1', createdAt: '2025-01-10' },
  { id: 'ws-4', type: 'workspace', name: 'Product Analytics', owner: 'user-3', createdAt: '2025-01-12' },
  { id: 'ws-5', type: 'workspace', name: 'Customer Support', owner: 'user-1', createdAt: '2025-01-15' }
];

// Sample documents for demonstrating nested resource checks
export const documents = [
  { id: 'doc-1', type: 'document', name: 'Q1 Strategy.pdf', workspaceId: 'ws-1' },
  { id: 'doc-2', type: 'document', name: 'Team Guidelines.md', workspaceId: 'ws-1' },
  { id: 'doc-3', type: 'document', name: 'Campaign Plan.docx', workspaceId: 'ws-2' }
];
